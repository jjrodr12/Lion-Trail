--2017
insert into semester(id,adminssion_start,adminssion_stop,
class_registration_date,drop_add_deadline_date,first_class_date,
first_exam_date,last_class_date,last_exam_date,
season,year) values (nextval('semester_id_seq'),'2017-01-01','2017-06-31',
...
first_exam_date,last_class_date,last_exam_date,
season,year) 
values (nextval('semester_id_seq'),'2017-06-01','2017-11-31',
...
first_exam_date,last_class_date,last_exam_date,
season,year) 
values (nextval('semester_id_seq'),'2018-01-01','2018-06-31',
...
first_exam_date,last_class_date,last_exam_date,
season,year) 
values (nextval('semester_id_seq'),'2018-06-01','2018-11-31',
...
first_exam_date,last_class_date,last_exam_date,
season,year) 
values (nextval('semester_id_seq'),'2019-01-01','2019-06-31',
...
first_exam_date,last_class_date,last_exam_date,
season,year) 
values (nextval('semester_id_seq'),'2019-06-01','2019-11-31',
...
insert into course(id, major_id, number, credits, name, description)
	...
	'This course provides an introduction to fundamentals of programming');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('course_id_seq'), 2, 510, 3, 'Object Oriented Design',
	'This course provides an introduction to Object Oriented Programming');
...
insert into major_group(id, size, major) values(1, 2, 2);
...
--CS
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 3, 101, 3, 'Programming with Python',
	'An introduction to programming using an intreperted langauge.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 3, 210, 3, 'Data Structures',
	'Provides an overview to common data structures and their analysis');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 3, 310, 3, 'Algorithims',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 3);
...
--EE
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 4, 110, 3, 'Electronic Priniciples',
	'Foundations of electronics');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 4, 215, 3, 'Digital Design Fundamentals',
	'Foundations of digital design');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 4, 340, 3, 'Power Systems Analysis',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 4);
...
--PAINT
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 5, 101, 3, 'Intro to Painting',
	'An introduction to Painting ');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 5, 220, 3, 'Painting People',
	'An overview of painting people');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 5, 350, 3, 'Underwater Painting',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 5);
...
--PHOTO
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 6, 101, 3, 'Intro to Photography',
	'An introduction to Photography. ');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 6, 220, 3, 'Photographing People',
	'An overview of photographing people');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 6, 350, 3, 'Selfies',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 6);
...
--POTT
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 7, 101, 3, 'Intro to Pottery',
	'An introduction to Pottery. ');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 7, 230, 3, 'Advance Pottery',
	'An overview of photographing people');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 7, 410, 3, 'Pottery Studo',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 7);
...
--BUS
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 8, 101, 3, 'Intro to Business',
	'An introduction to business. ');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 8, 240, 3, 'Operating and Planning',
	'An overview of operations and planning in the modern day work place.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 8, 351, 3, 'Management',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 8);
...
--FIN
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 9, 110, 3, 'Intro to Finance',
	'An introduction to finance. ');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 9, 240, 3, 'Financial Modeling',
	'Numerical methods used in modern day finance.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 9, 351, 3, 'Advance Excel',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 9);
...
--MKT
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 10, 110, 3, 'Intro to Marketing',
	'An introduction to finance. ');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 10, 240, 3, 'Marketing Research',
	'Research methods used in Marketing.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 10, 351, 3, 'Business to Busineess Marketing.',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 10);
...
--MED
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 11, 510, 3, 'Anatomy and Physiology',
	'Systems view of mamilian A&P.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 11, 640, 3, 'Ethics',
	'In depth overview of governing ethics in medicine');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 11, 751, 3, 'Clinical internship',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 11);
...
--LAW
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 12, 515, 3, 'Legal Research',
	'Research methods used in law.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 12, 540, 3, 'Ethics',
	'In depth overview of governing ethics in law');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 12, 751, 3, 'Legal Practicum',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 12);
...
--APM
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 13, 115, 3, 'Foundations of Applied Mathematics',
	'An overview of methods used in applied mathematics');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 13, 240, 3, 'Computational Methods',
	'This course explore computing used to solve applied problems');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 13, 451, 3, 'Numerical Analysis',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 1, 13);
...
--MAT-U
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 14, 100, 3, 'College Mathematics',
	'A foundation of mathematics for math majors.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 14, 225, 3, 'Probability Theory',
	'is the branch of mathematics concerned with probability.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 14, 451, 3, 'Dynamic Systems.',
...
insert into major_group(id, size, major) values(nextval('major_group_id_seq'), 2, 14);
...
--MAT-G
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 15, 520, 3, 'Computational Mathematics',
	'In depth coverage of computional methods for numerical problem solving.');
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 15, 631, 3, 'Nonlinear Phenomena',
...
insert into course(id, major_id, number, credits, name, description)
	values(nextval('cohort_id_seq'), 15, 651, 3, 'Advance Probability Theory',
...
insert into major_group(id, size, major) values(nextval(13, 2, 15);
